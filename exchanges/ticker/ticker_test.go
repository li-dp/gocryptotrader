...
func TestCreateNewTicker(t *testing.T) {
	...
	if reflect.TypeOf(newTicker.Price["BTC"]["USD"][assets.AssetTypeSpot].Ask).String() != "float64" {
		t.Error("Test Failed - ticker newTicker.Price[BTC][USD].Ask value is not a float64")
	}
	if reflect.TypeOf(newTicker.Price["BTC"]["USD"][assets.AssetTypeSpot].Bid).String() != "float64" {
	...
	if reflect.TypeOf(newTicker.Price["BTC"]["USD"][assets.AssetTypeSpot].High).String() != "float64" {
		t.Error("Test Failed - ticker newTicker.Price[BTC][USD].High value is not a float64")
	}
	if reflect.TypeOf(newTicker.Price["BTC"]["USD"][assets.AssetTypeSpot].Last).String() != "float64" {
		t.Error("Test Failed - ticker newTicker.Price[BTC][USD].Last value is not a float64")
	}
	if reflect.TypeOf(newTicker.Price["BTC"]["USD"][assets.AssetTypeSpot].Low).String() != "float64" {
		t.Error("Test Failed - ticker newTicker.Price[BTC][USD].Low value is not a float64")
	}
	if reflect.TypeOf(newTicker.Price["BTC"]["USD"][assets.AssetTypeSpot].PriceATH).String() != "float64" {
		t.Error("Test Failed - ticker newTicker.Price[BTC][USD].PriceATH value is not a float64")
	}
	if reflect.TypeOf(newTicker.Price["BTC"]["USD"][assets.AssetTypeSpot].Volume).String() != "float64" {
